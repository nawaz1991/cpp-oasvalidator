...
class ArrayDeserializerTest
    : public ::testing::TestWithParam<
          std::tuple<std::string, char, bool, PrimitiveType, char, bool, bool, std::string, bool>>
{
protected:
    void SetUp() override
    {
        ...
        deserializer_ = std::make_unique<ArrayDeserializer>("test", start_char, skip_name, items_type, separator,
                                                            has_running_name, has_20_separator);
        input_ = input;
        expected_ = expected;
...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        std::make_tuple("true,false", '\0', false, PrimitiveType::BOOLEAN, ',', false, false, "[true,false]", false),
        ...
        std::make_tuple("abc,def,ghi", '\0', false, PrimitiveType::STRING, ',', false, false,
                        "[\"abc\",\"def\",\"ghi\"]", false),
        std::make_tuple("test=true,false", '\0', true, PrimitiveType::BOOLEAN, ',', false, false, "[true,false]",
                        false),
        std::make_tuple("test=1,2,3", '\0', true, PrimitiveType::INTEGER, ',', false, false, "[1,2,3]", false),
        std::make_tuple("test=1.1,2.2,3.3", '\0', true, PrimitiveType::NUMBER, ',', false, false, "[1.1,2.2,3.3]",
                        false),
        std::make_tuple("test=abc,def,ghi", '\0', true, PrimitiveType::STRING, ',', false, false,
                        "[\"abc\",\"def\",\"ghi\"]", false),
        ...
        std::make_tuple(".abc,def,ghi", '.', false, PrimitiveType::STRING, ',', false, false,
                        "[\"abc\",\"def\",\"ghi\"]", false),
        std::make_tuple(".true.false", '.', false, PrimitiveType::BOOLEAN, '.', false, false, "[true,false]", false),
        std::make_tuple(".1.2.3", '.', false, PrimitiveType::INTEGER, '.', false, false, "[1,2,3]", false),
        // std::make_tuple(".1.1.2.2.3.3", '.', false, PrimitiveType::NUMBER, '.', false, false, "[1.1,2.2,3.3]",
        // false), // NOT a valid serialization
        std::make_tuple(".abc.def.ghi", '.', false, PrimitiveType::STRING, '.', false, false,
                        "[\"abc\",\"def\",\"ghi\"]", false),
        std::make_tuple(";test=true,false", ';', true, PrimitiveType::BOOLEAN, ',', false, false, "[true,false]",
                        false),
        std::make_tuple(";test=1,2,3", ';', true, PrimitiveType::INTEGER, ',', false, false, "[1,2,3]", false),
        std::make_tuple(";test=1.1,2.2,3.3", ';', true, PrimitiveType::NUMBER, ',', false, false, "[1.1,2.2,3.3]",
                        false),
        std::make_tuple(";test=abc,def,ghi", ';', true, PrimitiveType::STRING, ',', false, false,
                        "[\"abc\",\"def\",\"ghi\"]", false),
        std::make_tuple(";test=true;test=false", ';', true, PrimitiveType::BOOLEAN, ';', true, false, "[true,false]",
                        false),
        ...
        std::make_tuple(";test=abc;test=def", ';', true, PrimitiveType::STRING, ';', true, false, "[\"abc\",\"def\"]",
                        false),
        std::make_tuple("?test=true&test=false", '?', true, PrimitiveType::BOOLEAN, '&', true, false, "[true,false]",
                        false),
        std::make_tuple("?test=1&test=2", '?', true, PrimitiveType::INTEGER, '&', true, false, "[1,2]", false),
        ...
        std::make_tuple("?test=abc&test=def", '?', true, PrimitiveType::STRING, '&', true, false, "[\"abc\",\"def\"]",
                        false),
        std::make_tuple("?test=true%20false", '?', true, PrimitiveType::BOOLEAN, '%', false, true, "[true,false]",
                        false),
        ...
        std::make_tuple("?test=abc%20def", '?', true, PrimitiveType::STRING, '%', false, true, "[\"abc\",\"def\"]",
                        false),
        ...
        std::make_tuple("abc%true-5.3", '\0', false, PrimitiveType::STRING, ',', false, false,
                        "[\"abc\",\"def\",\"ghi\"]", true)));

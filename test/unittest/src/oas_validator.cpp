...
TEST_F(OASValidatorTest, ValidateRoute)
{
    ...
    EXPECT_EQ(ValidationError::NONE,
              validator_->ValidateRoute("GET", "/test/string_matrix_true/;param=abc%20xyz", err_msg));
    EXPECT_EQ(ValidationError::NONE,
              validator_->ValidateRoute("GET", "/test/string_matrix_true/;param=abc%2xyz", err_msg));
}
...
TEST_F(OASValidatorTest, ValidatePathParam)
{
    ...
    EXPECT_EQ(ValidationError::INVALID_PATH_PARAM,
              validator_->ValidatePathParam("GET", "/test/integer_simple_true/123str", err_msg));
    EXPECT_EQ(ValidationError::NONE, validator_->ValidatePathParam("GET", "/test/integer_label_true/.123", err_msg));
    EXPECT_EQ(ValidationError::INVALID_PATH_PARAM,
              validator_->ValidatePathParam("GET", "/test/integer_label_true/123", err_msg));
    EXPECT_EQ(ValidationError::NONE,
              validator_->ValidatePathParam("GET", "/test/integer_matrix_true/;param=123", err_msg));
    EXPECT_EQ(ValidationError::INVALID_PATH_PARAM,
              validator_->ValidatePathParam("GET", "/test/integer_matrix_true/;123", err_msg));
    EXPECT_EQ(ValidationError::NONE,
              validator_->ValidatePathParam("GET", "/test/string_simple_true/abc%20xyz", err_msg));
    EXPECT_EQ(ValidationError::INVALID_PATH_PARAM,
              validator_->ValidatePathParam("GET", "/test/string_simple_true/abc%2xyz", err_msg));
    EXPECT_EQ(ValidationError::INVALID_PATH_PARAM,
              validator_->ValidatePathParam("GET", "/test/string_label_true/.abc%20xyz", err_msg));
    EXPECT_EQ(ValidationError::INVALID_PATH_PARAM,
              validator_->ValidatePathParam("GET", "/test/string_label_true/abc%2xyz", err_msg));
    EXPECT_EQ(ValidationError::NONE,
              validator_->ValidatePathParam("GET", "/test/string_matrix_true/;param=abc%20xyz", err_msg));
    EXPECT_EQ(ValidationError::INVALID_PATH_PARAM,
              validator_->ValidatePathParam("GET", "/test/string_matrix_true/;param=abc%2xyz", err_msg));
}
...
TEST_F(OASValidatorTest, ValidateQueryParam)
{
    std::string err_msg;
    EXPECT_EQ(ValidationError::NONE,
              validator_->ValidateQueryParam("GET", "/test/query_integer_form_true?param=123", err_msg));
    EXPECT_EQ(ValidationError::INVALID_QUERY_PARAM,
              validator_->ValidateQueryParam("GET", "/test/query_integer_form_true?param=123str", err_msg));
    EXPECT_EQ(ValidationError::NONE,
              validator_->ValidateQueryParam("GET", "/test/query_two_integer_form_mixed?param1=123&param2=456",
                                             err_msg));
...
TEST_F(OASValidatorTest, ValidateHeaders)
{
    ...
    EXPECT_EQ(ValidationError::INVALID_HEADER_PARAM,
              validator_->ValidateHeaders("GET", "/test/header_single1", headers, err_msg));
    headers.clear();
    ...
    EXPECT_EQ(ValidationError::INVALID_HEADER_PARAM,
              validator_->ValidateHeaders("GET", "/test/header_single5", headers, err_msg));
    headers.clear();
    headers["objectHeader"] = "field1=123,field2=abc";
    ...
    headers["objectHeader"] = "field1,123,field2,abc";
    EXPECT_EQ(ValidationError::INVALID_HEADER_PARAM,
              validator_->ValidateHeaders("GET", "/test/header_triple5", headers, err_msg));
}
...
TEST_F(OASValidatorTest, ValidateBody)
{
    ...
    EXPECT_EQ(ValidationError::INVALID_BODY,
              validator_->ValidateBody("POST", "/test/body_scenario1", "123str", err_msg));
    EXPECT_EQ(ValidationError::NONE,
              validator_->ValidateBody("POST", "/test/body_scenario20",
                                       "{\"level1\":{\"level2\":{\"level3\":\"abc\"}}}", err_msg));
    EXPECT_EQ(ValidationError::INVALID_BODY,
              validator_->ValidateBody("POST", "/test/body_scenario20", "{\"level1\":{\"level2\":{\"level3\":123}}}",
                                       err_msg));
}
...
TEST_F(OASValidatorTest, ValidateRequst)
{
    ...
    EXPECT_EQ(ValidationError::INVALID_PATH_PARAM,
              validator_->ValidateRequest("GET", "/test/integer_simple_true/123str", err_msg));
    EXPECT_EQ(ValidationError::NONE, validator_->ValidateRequest("GET", "/test/integer_label_true/.123", err_msg));
    EXPECT_EQ(ValidationError::INVALID_PATH_PARAM,
              validator_->ValidateRequest("GET", "/test/integer_label_true/123", err_msg));
    EXPECT_EQ(ValidationError::NONE,
              validator_->ValidateRequest("GET", "/test/integer_matrix_true/;param=123", err_msg));
    EXPECT_EQ(ValidationError::INVALID_PATH_PARAM,
              validator_->ValidateRequest("GET", "/test/integer_matrix_true/;123", err_msg));
    EXPECT_EQ(ValidationError::NONE, validator_->ValidateRequest("GET", "/test/string_simple_true/abc%20xyz", err_msg));
    EXPECT_EQ(ValidationError::INVALID_PATH_PARAM,
              validator_->ValidateRequest("GET", "/test/string_simple_true/abc%2xyz", err_msg));
    EXPECT_EQ(ValidationError::INVALID_PATH_PARAM,
              validator_->ValidateRequest("GET", "/test/string_label_true/.abc%20xyz", err_msg));
    EXPECT_EQ(ValidationError::INVALID_PATH_PARAM,
              validator_->ValidateRequest("GET", "/test/string_label_true/abc%2xyz", err_msg));
    EXPECT_EQ(ValidationError::NONE,
              validator_->ValidateRequest("GET", "/test/string_matrix_true/;param=abc%20xyz", err_msg));
    EXPECT_EQ(ValidationError::INVALID_PATH_PARAM,
              validator_->ValidateRequest("GET", "/test/string_matrix_true/;param=abc%2xyz", err_msg));
    EXPECT_EQ(ValidationError::NONE,
              validator_->ValidateRequest("GET", "/test/query_integer_form_true?param=123", err_msg));
    EXPECT_EQ(ValidationError::INVALID_QUERY_PARAM,
              validator_->ValidateRequest("GET", "/test/query_integer_form_true?param=123str", err_msg));
    EXPECT_EQ(ValidationError::NONE,
              validator_->ValidateRequest("GET", "/test/query_two_integer_form_mixed?param1=123&param2=456", err_msg));
    ...
    EXPECT_EQ(ValidationError::NONE,
              validator_->ValidateRequest("GET", "/test/integer_simple_true/123", "", dummy, err_msg));
    EXPECT_EQ(ValidationError::NONE,
              validator_->ValidateRequest("GET", "/test/integer_simple_true/123", dummy, err_msg));
    EXPECT_EQ(ValidationError::INVALID_METHOD,
              validator_->ValidateRequest("GET1", "/test/integer_simple_true/123", dummy, err_msg));
    ...
    EXPECT_EQ(
        ...
        validator_->ValidateRequest(
            ...
            "\"subfield2\":"
            "\"abc\"},\"field5\":{\"subfield1\":123},\"field6\":\"abc\",\"field7\":[123,456],\"field8\":[123,456],"
            "\"field9\":"
    ...
    EXPECT_EQ(ValidationError::NONE,
              validator_->ValidateRequest("GET",
                                          ...
                                          "%7B%0A%20%20%22field1%22%3A%200%2C%0A%20%20%22field2%22%3A%20%22string%22%"
                                          "0A%7D?param4=%5B%22str1%22%2C%22str2%22%5D&param5=%7B%0A%20%"
                                          "20%22field1%22%3A%200%2C%0A%20%20%22field2%22%3A%20%22string%22%0A%7D&"
                                          "param6=%7B%0A%20%20%22field1%22%3A%200%2C%0A%20%20%22field2%22%3A%"
                                          "20%22string%22%0A%7D&param7=%7B%0A%20%20%22field1%22%3A%200%2C%0A%20%20%"
                                          "22field2%22%3A%20%22string%22%0A%7D",
                                          err_msg));
}
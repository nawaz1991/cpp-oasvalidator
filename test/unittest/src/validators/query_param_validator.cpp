...
INSTANTIATE_TEST_SUITE_P(
    QueryPrimitiveParamTests, QueryPrimitiveParam,
...
INSTANTIATE_TEST_SUITE_P(
    QueryArrayParamTests, QueryArrayParam,
    ::testing::Values(
        std::make_tuple("param=3,4,5", "form", false, "integer", ValidationError::NONE),
        ...
        std::make_tuple("param=abc%20xyz&param=def%20xyz&param=ghi%20xyz", "form", true, "string",
        ...
        std::make_tuple("param=string&param=abc&param=xyz", "form", true, "integer",
        ...
        std::make_tuple("param=true&param=false&param=true", "form", true, "number",
                        ValidationError::INVALID_QUERY_PARAM),
        ...
        std::make_tuple("param=abc%20xyz%20def%20xyz%20ghi%20xyz", "spaceDelimited", false, "string",
                        ValidationError::NONE),
        std::make_tuple("param=abc%20xyz&param=def%20xyz&param=ghi%20xyz", "spaceDelimited", true, "string",
                        ValidationError::NONE),
        ...
        std::make_tuple("param=string%20abc%20xyz", "spaceDelimited", false, "integer",
                        ValidationError::INVALID_QUERY_PARAM),
        std::make_tuple("param=string&param=abc&param=xyz", "spaceDelimited", true, "integer",
                        ValidationError::INVALID_QUERY_PARAM),
        ...
        std::make_tuple("param=abc%20xyz&param=def%20xyz&param=ghi%20xyz", "pipeDelimited", true, "string",
                        ValidationError::NONE),
        ...
        std::make_tuple("param=string|abc|xyz", "pipeDelimited", false, "integer",
                        ValidationError::INVALID_QUERY_PARAM)));
...
INSTANTIATE_TEST_SUITE_P(
    QueryObjectParamTests, QueryObjectParam,
    ::testing::Values(
        std::make_tuple("param=boolTrue,true,boolFalse,false,int,123,number,123.456,string,abc%20xyz", "form", false,
                        ValidationError::NONE),
        std::make_tuple("boolTrue=true&boolFalse=false&int=123&number=123.456&string=abc%20xyz", "form", true,
                        ValidationError::NONE),
        std::make_tuple(
            "param[boolTrue]=true&param[boolFalse]=false&param[int]=123&param[number]=123.456&param[string]=abc%20xyz",
            "deepObject", true, ValidationError::NONE)));
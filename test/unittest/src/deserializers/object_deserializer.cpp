...
class ObjectDeserializerTest
    : public ::testing::TestWithParam<std::tuple<std::string, char, bool, char, char, bool, bool>>
{
protected:
    void SetUp() override
    {
        ...
        deserializer_ = std::make_unique<ObjectDeserializer>("test", start_char, skip_name, kv_separator, vk_separator,
                                                             is_deep_obj, KT_MAP);
        input_ = input;
...
INSTANTIATE_TEST_SUITE_P(
    ObjectDeserializerTests, ObjectDeserializerTest,
    ::testing::Values(
        std::make_tuple("boolTrue,true,boolFalse,false,int,123,number,123.456,string,abc%20xyz", '\0', false, ',', ',',
                        false, false),
        std::make_tuple("boolTrue=true,boolFalse=false,int=123,number=123.456,string=abc%20xyz", '\0', false, '=', ',',
                        false, false),
        std::make_tuple(".boolTrue,true,boolFalse,false,int,123,number,123.456,string,abc%20xyz", '.', false, ',', ',',
                        false, false),
        std::make_tuple(".boolTrue=true,boolFalse=false,int=123,number=123.456,string=abc%20xyz", '.', false, '=', ',',
                        false, false),
        std::make_tuple(";test=boolTrue,true,boolFalse,false,int,123,number,123.456,string,abc%20xyz", ';', true, ',',
                        ',', false, false),
        std::make_tuple(";boolTrue=true;boolFalse=false;int=123;number=123.456;string=abc%20xyz", ';', false, '=', ';',
                        false, false),
        std::make_tuple("?boolTrue=true&boolFalse=false&int=123&number=123.456&string=abc%20xyz", '?', false, '=', '&',
        ...
        std::make_tuple("?test=boolTrue,true,boolFalse,false,int,123,number,123.456,string,abc%20xyz", '?', true, ',',
                        ',', false, false),
        std::make_tuple(
            "?test[boolTrue]=true&test[boolFalse]=false&test[int]=123&test[number]=123.456&test[string]=abc%20xyz", '?',
            true, '=', '&', true, false),
        std::make_tuple("boolTrue,true,boolFalse,false,int,str,number,123.456,string,abc%20xyz", '\0', false, ',', ',',
                        false, true),
        std::make_tuple("boolTrue=true,boolFalse=false,int=123,number=123.456,string=abc%2xyz", '\0', false, '=', ',',
                        false, true),
        std::make_tuple(".boolTrue,true,boolFalse,false,int,123,number,1.23.456,string,abc%20xyz", '.', false, ',', ',',
                        false, true),
        std::make_tuple(".boolTrue;true,boolFalse=false,int=123,number=123.456,string=abc%20xyz", '.', false, '=', ',',
                        false, true),
        std::make_tuple("test=boolTrue,true,boolFalse,false,int,123,number,123.456,string,abc%20xyz", ';', true, ',',
